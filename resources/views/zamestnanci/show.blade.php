...
@section('content')
    <div class="card uper">
        ...
        <div class="card-body">
            ...
            <div class=" form-group">
                <label>email:</label>
                <input disabled type="text" class="form-control" name="email" value="{{ $zamestnanci->email }}"/>
            </div>
            <div class=" form-group">
                <label>telefon:</label>
                <input disabled type="text" class="form-control" name="telefon" value="{{ $zamestnanci->telefon }}"/>
            </div>
            <div class=" form-group">
            ...
            <div class=" form-group">
                ...
                <input disabled type="date" class="form-control" name="zamestnany_do" value="{{ $zamestnanci->zamestnany_do }}"/>
            </div>
            <div class=" form-group">
